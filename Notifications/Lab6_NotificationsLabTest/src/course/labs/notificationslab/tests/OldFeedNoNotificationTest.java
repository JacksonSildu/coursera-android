...
public class OldFeedNoNotificationTest extends ActivityInstrumentationTestCase2<TestFrontEndActivity> {
	...
	public void testRun() {
		...
		assertTrue("course.labs.notificationslab.MainActivity is not found!", solo.waitForActivity(course.labs.notificationslab.MainActivity.class, shortDelay));
		...
		assertTrue("'" + msg + "	' is not shown!", solo.searchText(msg));
