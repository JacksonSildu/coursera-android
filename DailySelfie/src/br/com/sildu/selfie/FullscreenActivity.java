...
import br.com.sildu.selfie.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		byte[] image = (byte[]) this.getIntent().getExtras().get(MainActivity.SELFIE);

		ImageView selfie = (ImageView) findViewById(R.id.selfieImage);
		selfie.setImageBitmap(BitmapFactory.decodeByteArray(image, 0, image.length));
