...
public class ActivityOne extends Activity {
	...
	public void displayCounts() {
		...
		Log.i(TAG, String.valueOf(mTvCreate.getText()));
		Log.i(TAG, String.valueOf(mTvStart.getText()));
		Log.i(TAG, String.valueOf(mTvResume.getText()));
		Log.i(TAG, String.valueOf(mTvRestart.getText()));
