...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		List<Integer> params = args.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] array = params.toArray(new Integer[]{});

		// TODO: Start the DownloaderTask
		downloadTask.execute(array);
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		protected String[] doInBackground(Integer... params) {
			String[] results = downloadTweets(params);
			return results;
		}
